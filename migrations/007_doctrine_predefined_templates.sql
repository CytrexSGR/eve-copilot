-- ============================================================
-- Migration 007: Predefined Doctrine Templates
-- ============================================================
-- Description: Restores predefined doctrine templates table
-- for the detector service while keeping DBSCAN tables.
-- ============================================================

BEGIN;

-- Predefined doctrine templates (for detector.py)
CREATE TABLE IF NOT EXISTS doctrine_predefined_templates (
...
INSERT INTO doctrine_predefined_templates (name, display_name, ship_type_ids, weapon_group_ids, tank_type, role, engagement_range, typical_dps_min, typical_dps_max) VALUES
...
-- Index for queries
CREATE INDEX IF NOT EXISTS idx_predefined_templates_active
    ON doctrine_predefined_templates(is_active) WHERE is_active = TRUE;

COMMENT ON TABLE doctrine_predefined_templates IS
    'Manually defined doctrine templates for ship fitting matching';
